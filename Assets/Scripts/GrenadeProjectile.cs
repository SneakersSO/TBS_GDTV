...
public class GrenadeProjectile : MonoBehaviour
{
    ...
    private void Update() 
    {
        ...
        float distanceNormalized = 1 - distance / totalDistance; //Inverting the value of distance

        float maxGrenadeArcHeight = totalDistance / 4f;
        float positionY = arcYAnimationCurve.Evaluate(distanceNormalized) * maxGrenadeArcHeight;
